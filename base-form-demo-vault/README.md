...
This vault demonstrates the BaseForm custom Bases view with text, list, number, checkbox, date, and date-and-time properties.
...
List values are entered one item per line. The main **Form** view uses the default
compact spacing and visible file names. The embedded **This - Form** view hides
the file name and uses tighter spacing to demonstrate the view options.
